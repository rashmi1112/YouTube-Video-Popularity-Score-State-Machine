 ...
 * Class for the mildly popular state extending the AbstractState class
 */
...
public class MildlyPopular extends AbstractState {
    ...
    public MildlyPopular(StateName stateName, ContextI context){
    ...
    public String toString(){
        return "Implements the mildly popular state methods.";
    }

    /**
     * Method to add video when the channel is in mildly popular state.
    ...
    /**
     * Method to remove video when the channel is in mildly popular state.
    ...
    /**
     * Method calculate the metrics when the channel is in mildly popular state.
    ...
    /**
     * Method to process the ad_request when the channel is in mildly popular state
     * @param videoName Name of the video
