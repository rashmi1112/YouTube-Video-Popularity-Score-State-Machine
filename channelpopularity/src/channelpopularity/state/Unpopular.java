 ...
 * Class for the unpopular state extending the AbstractState class
 */
public class Unpopular extends AbstractState {
    ...
    public Unpopular(StateName stateName, ContextI context) {
    ...
    public String toString(){
        return "Implements the unpopular state methods.";
    }

    /**
     * Method to add video when the channel is in unpopular state.
    ...
    /**
     * Method to remove video when the channel is in unpopular state.
    ...
    public void removeVideo(String videoName, FileDisplayInterface fileDisplayInterfaceIn, StdoutDisplayInterface stdoutDisplayInterfaceIn) {
        ...
        if(videos.containsKey(videoName)) {
            ...
            throw new IllegalArgumentException("Video " + videoName + " not exists!");
        }
    }

    /**
     * Method calculate the metrics when the channel is in unpopular state.
    ...
    /**
     * Method to process the ad_request when the channel is in unpopular state
     * @param videoName Name of the video
