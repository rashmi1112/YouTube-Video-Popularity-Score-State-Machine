 ...
 * Class for the highly popular state extending the AbstractState class
 */
public class HighlyPopular extends AbstractState{
    ...
    public HighlyPopular(StateName stateName, ContextI context){
    ...
    public String toString(){
        return "Implements the highly popular state methods.";
    }

    /**
     * Method to add video when the channel is in highly popular state.
    ...
    /**
     * Method to remove video when the channel is in highly popular state.
    ...
    /**
     * Method calculate the metrics when the channel is in highly popular state.
    ...
    /**
     * Method to process the ad_request when the channel is in highly popular state
     * @param videoName Name of the video
